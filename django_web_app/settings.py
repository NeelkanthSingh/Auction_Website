...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '/blog/templates/blog/'),os.path.join(BASE_DIR, '/users/templates/users/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "checkitout287@gmail.com"
EMAIL_HOST_PASSWORD = "khanakhajana"
